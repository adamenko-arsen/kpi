...
class Helper:
    ...
    def TryGetMutatedAndImprove(
        ...
        capacity: float,
        mutator: Callable[[Entity.Entity, float], Dict],
        mutate_chance: float
    ) -> Optional[Entity.Entity]:
        child_a_mut = child_a.Copy()
        child_a_mut_info = {**mutator(child_a_mut, mutate_chance), 'entity': child_a_mut}

        child_b_mut = child_b.Copy()
        child_b_mut_info = {**mutator(child_b_mut, mutate_chance), 'entity': child_b_mut}
...
class Evolutor:
    ...
    def SetMutator(self, mutator: Callable[[Entity.Entity, float], Dict]):
